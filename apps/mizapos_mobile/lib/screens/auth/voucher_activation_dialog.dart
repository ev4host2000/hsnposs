...
class _VoucherActivationDialogState extends State<_VoucherActivationDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final railWidth = size.width >= 760 ? 340.0 : 280.0;
    ...
    return Dialog(
      ...
      child: ConstrainedBox(
        constraints: BoxConstraints(
          maxWidth: wide ? 940 : size.width - 24,
          maxHeight: math.min(size.height * 0.92, wide ? 660 : 820),
        ),
        child: Material(
          color: cs.surface,
          elevation: 24,
                    ...
                    return IntrinsicHeight(
                      child: Row(
                        ...
                        children: [
                          SizedBox(
                            width: railWidth,
                            child: const SubscriptionPlanCard(rail: true),
                          ),
                          VerticalDivider(
                            width: 1,
                            thickness: 1,
...
class _SignInOrRegisterPanelState extends State<_SignInOrRegisterPanel>
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        if (widget.embedPlan) ...[
          const SubscriptionPlanCard(banner: true),
          const SizedBox(height: 14),
        ],
        DecoratedBox(
          decoration: BoxDecoration(
