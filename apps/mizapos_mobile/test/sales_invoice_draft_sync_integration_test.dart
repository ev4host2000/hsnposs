...
/// Sales invoice draft sync — requires backend on 127.0.0.1:8787.
void main() {
  ...
  Future<void> enqueueDraft({
    ...
    final envelope = salesInvoiceDraftPushEnvelope(
  ...
  test('device A create draft → push → device B pull → update → delete', () async {
    ...
    await db.delete('salesInvoiceItems', where: 'invoiceId = ?', whereArgs: [invoiceId]);
    ...
    final cancelEnvelope = salesInvoiceDraftPushEnvelope(
