...
Map<String, dynamic> supplierPaymentPostAggregate({
  required String id,
...
Map<String, dynamic> supplierPaymentPostPushEnvelope({
...
List<Map<String, dynamic>> supplierPaymentCashJsonFromStageData(
  ...
  if (cash is SupplierPaymentCashEffect) {
    return SupplierPaymentPostEffects.cashJson(cash);
  }
  return const [];
}

List<Map<String, dynamic>> supplierPaymentAccountingJsonFromStageData(
  Map<String, Object?> stageData,
) {
  ...
  if (accounting is SupplierPaymentAccountingEffect) {
    return SupplierPaymentPostEffects.accountingJson(accounting);
  }
  return const [];
}
