...
class PurchaseReturnInventoryPostingStage extends PostingStage {
  ...
  Future<PostingStageResult> run(PostingContext context) async {
    ...
    try {
      for (final effect in inventory) {
        await PurchaseReturnPostDb.applyInventoryEffect(
          context.txn,
          effect: effect,
    ...
    context.stageData['inventory_movements'] =
        PurchaseReturnPostEffects.inventoryJson(inventory);
