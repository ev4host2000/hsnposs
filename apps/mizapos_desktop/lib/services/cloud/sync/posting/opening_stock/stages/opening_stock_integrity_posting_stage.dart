...
import 'package:mizapos_desktop/services/cloud/sync/posting/shared/opening_stock_integrity_verifier.dart';
...
class OpeningStockIntegrityPostingStage extends PostingStage {
  ...
  Future<PostingStageResult> run(PostingContext context) async {
    try {
      ...
      await OpeningStockIntegrityVerifier.verify(
        context: context,
        referenceType: 'opening_stock',
        loadOpeningStock: OpeningStockPostDb.loadOpeningStock,
        statusColumn: 'openingStatus',
        openingQuantity: _headerOpeningQuantity(context),
        inventory: OpeningStockEffectView(
  ...
  double _headerOpeningQuantity(PostingContext context) {
    final resolved = context.stageData['resolved_opening_quantity'];
    ...
    final extra = context.aggregate.header is MapTransactionHeader
        ...
        : const {};
    final value = extra['opening_quantity'];
