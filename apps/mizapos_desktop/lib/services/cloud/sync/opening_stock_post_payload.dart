...
Map<String, dynamic> openingStockPostAggregate({
  required String id,
...
Map<String, dynamic> openingStockPostPushEnvelope({
...
List<Map<String, dynamic>> openingStockInventoryJsonFromStageData(
  ...
  if (inventory is OpeningStockInventoryEffect) {
    return OpeningStockPostEffects.inventoryJson(inventory);
  }
  return const [];
}
