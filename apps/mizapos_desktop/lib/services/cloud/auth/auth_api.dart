...
class AuthApi {
  ...
  static const String pairingLoginPath = '/auth/login/pairing';
  static const String refreshPath = '/auth/token/refresh';
  static const String logoutPath = '/auth/logout';
  static const String forgotPasswordPath = '/auth/password/forgot';
  ...
  Future<CloudApiResponse<LoginResponse>> loginPairing(
    ...
    final http = await _apiClient.post(
      ...
      body: jsonEncode({
        ...
        if (request.companyId != null && request.companyId!.isNotEmpty)
          'company_id': request.companyId,
        if (request.branchId != null && request.branchId!.isNotEmpty)
  ...
  Future<CloudApiResponse<void>> forgotPassword({required String email}) async {
    final http = await _apiClient.post(
      forgotPasswordPath,
