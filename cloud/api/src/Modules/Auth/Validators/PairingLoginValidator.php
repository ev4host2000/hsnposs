...
/**
 * تسجيل دخول مؤقت لربط جهاز جديد — بدون device_id مسجّل مسبقاً.
 * company_id و branch_id اختياريان؛ يُستنتجان من البريد عند الغياب.
 */
final class PairingLoginValidator extends AuthValidator
{
