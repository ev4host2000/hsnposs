...
final class SalesInvoicesPushValidator extends TransactionPushValidator
{
    ...
    private function validateVoidPayload(array $payload, string $prefix): array
    {
        ...
        if ($customerId === '' || !Uuid::isValid($customerId)) {
            $errors[] = "{$prefix}.payload_json.aggregate.header.customer_id:Valid customer_id is required for void";
        }
