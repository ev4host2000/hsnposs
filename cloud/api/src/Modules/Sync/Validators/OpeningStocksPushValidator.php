...
final class OpeningStocksPushValidator extends TransactionPushValidator
{
    ...
    private function validatePostPayload(array $payload, string $prefix): array
    {
        ...
        if ($openingQuantity < 1e-9) {
            $errors[] = "{$prefix}.payload_json.aggregate.header.opening_quantity:opening_quantity must be positive for post";
        }
