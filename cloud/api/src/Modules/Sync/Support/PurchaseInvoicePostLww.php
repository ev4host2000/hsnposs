...
/**
 * Post handler for purchase invoices — inventory + accounting + finalize.
 */
trait PurchaseInvoicePostLww
{
    /**
     * @param array<string, mixed> $payloadJson
     * @return array<string, mixed>
     */
    protected function applyPurchaseInvoicePost(
        string $companyId,
        string $branchId,
        string $entityId,
        array $payloadJson,
        ...
        foreach ($inventory as $movement) {
            ...
            $this->applyStockMovementIdempotent(
                ...
                (string) ($movement['reference_type'] ?? 'purchase'),
        ...
        $hasPostedAt = $this->purchaseInvoiceHasPostedAt();
    ...
    protected function purchaseInvoiceHasPostedAt(): bool
    {
        static $cached = null;
        if ($cached !== null) {
            return $cached;
